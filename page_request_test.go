...
func TestPageRequestMapSortFields(t *testing.T) {
	tests := []struct {
		name     string
		sort     []Sort
		...
		},
		{
			...
			sort:     []Sort{{Field: "createdAt", Direction: DESC}, {Field: "updatedAt", Direction: ASC}},
			fieldMap: map[string]string{"createdAt": "created_at", "updatedAt": "updated_at"},
			expected: []Sort{{Field: "created_at", Direction: DESC}, {Field: "updated_at", Direction: ASC}},
		},
		{
			name:     "no matching fields keeps original",
